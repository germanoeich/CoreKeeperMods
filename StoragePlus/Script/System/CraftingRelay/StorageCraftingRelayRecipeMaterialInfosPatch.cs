...
[HarmonyPatch(typeof(CraftingHandler), nameof(CraftingHandler.GetCraftingMaterialInfosForRecipe), new[] { typeof(CraftingHandler.RecipeInfo), typeof(List<Entity>), typeof(bool), typeof(bool), typeof(bool) })]
public static class StorageCraftingRelayRecipeMaterialInfosPatch
{
    [HarmonyPostfix]
